    ...
    array(
      ...
      'fields' => array(
        ...
        array(
          ...
          'dependency' => array( 'wx_top_ad_switcher', '==', 'true' ) // dependency rule
        ),
        array(
          'id'         => 'wx_footer_ad_switcher',
          'type'       => 'switcher',
          'title'      => '是否开启底部广告',
          'default'    => true
        ),
        array(
          ...
          'fields'    => array(
            ...
            array(
              'id'    => 'wx_footer_ad_link',
              'type'  => 'text',
              'title' => '跳转地址',
            ),
          ),
          'dependency' => array( 'wx_footer_ad_switcher', '==', 'true' ) // dependency rule
        ),
      ),
    ),
